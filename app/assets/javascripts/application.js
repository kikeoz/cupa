			...
			$.ajax({
				...
				success: function(medicamentos){
					...
					$.each(medicamentos,function(index,medicamento){
						...
						$(".medList").append(
							"<table width=70%><tr><td width=10%><b> CLAVE: </b>" + medicamento.med_id + 
							"</td><td width=50%> <b> DESCRIPCION: </b>" + medicamento.med_nombre +
							"</td><td width=10%><b> LINEA: </b>" + medicamento.med_linea + 
							"</td></tr></table><hr>")
					})
				},
				error: function(){
